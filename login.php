	...
	<body>
		...
		<div class="wrapper pa-0">
			<header class="sp-header">
				...
				<div class="form-group mb-0 pull-right">
					<span class="inline-block pr-10">Еще нет аккаунта?</span>
					<a class="inline-block btn btn-info btn-rounded btn-outline" href="signup.php">Регистрация</a>
				</div>
							...
							<div class="auth-form  ml-auto mr-auto no-float">
								<div class="row">
									<div class="col-sm-12 col-xs-12">
										<div class="mb-30">
											<h3 class="text-center txt-dark mb-10">Авторизация в Insta</h3>
											<h6 class="text-center nonecase-font txt-grey">Введите данные ниже</h6>
										</div>
										<div class="form-wrap">
											<form action="">
												<div class="form-group">
													<label class="control-label mb-10" for="exampleInputEmail_2">Телефон</label>
													<input type="text" data-mask="89999999999" class="form-control"  required="" id="tel" placeholder="Введите телефон">
												</div>
												<div class="form-group">
													<label class="pull-left control-label mb-10" for="exampleInputpwd_2">Пароль</label>
													<!-- <a class="capitalize-font txt-primary block mb-10 pull-right font-12" href="forgot-password.html">забыли пароль?</a> -->
													<div class="clearfix"></div>
													<input type="password" class="form-control" required="" id="pass" placeholder="Введите пароль">
												</div>

												<!-- <div class="form-group">
													<div class="checkbox checkbox-primary pr-10 pull-left">
														<input id="checkbox_2" required="" type="checkbox">
														<label for="checkbox_2">Запомнить меня</label>
													</div>
													<div class="clearfix"></div>
												</div> -->
												...
												<div class="form-group text-center">
													<button type="button" id="auth" class="btn btn-info btn-rounded">Войти</button>
												</div>
											</form>
										</div>
									</div>
		...
		<script>
			...
			$('#auth').click(function () {
				...
				var reload = function () {
					$('#auth').text('Перенаправляем в кабинет');
					setTimeout(function () {
				...
				$.ajax({
					...
					success: function (data) {
						if(data == 'Готово') {
							$('#auth').text('Вы успешно авторизовались');
							$('#errorBlock').hide();
							$('#tel').val('');
							$('#pass').val('');
